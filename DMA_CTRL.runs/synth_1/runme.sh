...
HD_PWD='D:/GITHUB_PROJECT/DMA_AXI_CTRL/DMA_CTRL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_soc_wrap.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dma_soc_wrap.tcl
