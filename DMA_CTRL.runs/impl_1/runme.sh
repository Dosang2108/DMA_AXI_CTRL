...
HD_PWD='D:/GITHUB_PROJECT/DMA_AXI_CTRL/DMA_CTRL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_soc_wrap.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dma_soc_wrap.tcl -notrace
